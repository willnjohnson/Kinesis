...
export function Sidebar({ isOpen, onClose, transcript, loading, title }: Props) {
                ...
                <div className="h-full flex flex-col">
                    <div className="p-8 border-b border-gray-900 flex justify-between items-start bg-gray-900/10">
                        <div className="flex flex-col gap-1.5">
                            <span className="text-[10px] font-bold uppercase tracking-[0.2em] text-gray-500">Video Content</span>
                    ...
                    <div className="p-8 border-t border-gray-900">
                        <button
                            ...
                            className="w-full bg-gray-900 border border-gray-800 text-gray-400 hover:text-white hover:border-gray-600 py-3 rounded-lg transition-all font-bold uppercase text-[10px] tracking-[0.2em] disabled:opacity-20 cursor-pointer"
                        >
